...
print("========================")
print(y_test[:5])
print(np.round(y_predict[:5]))  #np.round:반올림 / 예측값을 반올림해서 0,1의 값이 나올 수 있도록해줌 (0.5까지는 0으로, 0.6부터는 1로)
#print(y_predict[:5])  
[1 1 0 1 0]
[[ 0.9509259 ]
 [ 1.0649431 ]
...
# acc = accuracy_score[y_test, y_predict]
# print('acc :', acc)
# =>오류뜸 : accuracy는 0/1 두개가 맞는지 아닌지 확인함, 그러나 y_test와 y_predict값(실수형태)은 0,1로 안나오니까 비교할 수 없음
# loss='mse'사용하면 무조건 실수가 나오므로 사용할 수 없다. 
# 마지막 아웃풋레이어, activation = 'sigmoid'사용/ loss = 'binary_crossentropy'사용
...
*stratify=y(o) #같은비율일때, 통상적으로 더 잘 나옴
results: [0.06227986887097359, 0.9824561476707458, 0.015651952475309372]
acc:  0.982456140350877
*stratify=y(x)
results: [0.12325089424848557, 0.9210526347160339, 0.041780561208724976]
