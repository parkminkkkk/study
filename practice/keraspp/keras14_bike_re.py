...
path_save = './_save/kaggle_bike/' 
submission.to_csv(path_save + 'submit_0307_1507.csv') #파일생성
...
-1.30352점/ train_size=0.8, random_state=34553, Dense(64, 32'relu', 16, 8 'relu', 1), activation='relu' mse, epoch=500, batch_size=32
